...
import { useClaimDailyPoints } from "@/hooks/useClaimDailyPoints";
...
export default function RewardJourneyGrid() {
  ...
  const progressPercentage = (totalPoints / 5000) * 100;

  return (
    <>
      <LevelUpModal isOpen={showModal} onClose={() => setShowModal(false)} />
        ...
        <div className="rounded-2xl bg-white shadow-[0_5px_15px_rgba(0,0,0,0.05)] transition-all duration-200 hover:-translate-y-[5px] hover:shadow-lg">
          <div className="flex items-center gap-2 rounded-t-2xl bg-primary-blue p-4">
            <svg
              ...
              data-prefix="fas"
              data-icon="award"
              className="svg-inline--fa fa-award h-5 w-5 text-secondary-purple"
              role="img"
          ...
          <article className="p-4">
            <div className="mb-4 flex items-center justify-between">
              <h2 className="text-5xl font-bold text-secondary-purple">
                {totalPoints}
              </h2>
        ...
        <div className="rounded-2xl bg-white shadow-[0_5px_15px_rgba(0,0,0,0.05)] transition-all duration-200 hover:-translate-y-[5px] hover:shadow-lg">
          ...
          <article className="mt-6 p-4 land-phone:mt-4">
            ...
            <button
              ...
              className={`mt-4 ${hasClaimed ? "bg-tertiary-gray text-gray-500" : "bg-secondary-purple text-white hover:-translate-y-[2px] hover:shadow-md"} flex w-full items-center justify-center gap-3 rounded-full py-3 text-sm font-bold transition-all duration-200`}
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
